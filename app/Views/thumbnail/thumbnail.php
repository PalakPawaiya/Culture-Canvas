...
<div class="content">
    <h2>Welcome, Thumbnail 🖼️ </h2>
    <div class="row mt-4">
        <div class="col-md-4">
            <div class="card bg-primary text-white p-3">
                <h5>Total Thumbnail 🖼️</h5>
                <h3><?php $total =  isset($videothumbnails) && is_array($videothumbnails) ?  count($videothumbnails) : 0;
                    echo $total;
                    ?>
        ...
        <div class="col-md-4">
            <div class="card bg-success text-white p-3">
                <h5>Active Thumbnail 🖼️</h5>
                <?php
                $active_videothumbnails = 0;
                $inactive_videothumbnails = 0;
                if (isset($videothumbnails) && is_array($videothumbnails)) {
                    foreach ($videothumbnails as $thumbnail) {
                        if ($thumbnail['status'] == 'Active') {
                            $active_videothumbnails = $active_videothumbnails + 1;
                        } else {
                            $inactive_videothumbnails = $inactive_videothumbnails + 1;
                        }
                    }
                }
                ?>
                ...
                <h3><?php echo $active_videothumbnails; ?></h3>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card bg-danger text-white p-3">
                <h5>Inactive Thumbnail 🖼️</h5>
                <h3> <?php echo $inactive_videothumbnails; ?></h3>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card border">
                    <div class="card-header border px-4">
                        <h4> Video Thumbnails
                            <a href="<?= base_url('thumbnail/addthumbnail') ?>" class="btn btn-primary float-end"> <span style="color: white;">➕</span>Add Thumbnail </a>

                        </h4><br>

                        <table id="thumbnailTable" class="display" class="table table-bordered col-md-4">
                            <thead>
                                <tr>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('thumbnail/editthumbnail/' . $row['id']) ?>" class="btn btn-success btn-sm " style="text-align: center; vertical-align: middle; margin: 2px;">Edit</a>
                                                <a href="<?= base_url('thumbnail/inactivethumbnail/' . $row['id'] . '/' . $row['status']) ?>" class="btn btn-danger btn-sm action-btn" style="min-width: 80px;"><?php echo  $row['status']  == 'Active' ? "Inactivate" : "Activate";  ?></a>
                                                <a href="<?= base_url('thumbnail/deletethumbnail/' . $row['id']) ?>" class="btn btn-danger btn-sm " onclick="return confirm('Are you sure you want to delete this thumbnail ?');">Delete</a>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Thumbnail Details</h5>
                                                                ...
                                                                <table class="table table-bordered table-sm">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <h5>
                                                                                <p><b>Category Name:</b>
                                                                                    <a href="<?= base_url('thumbnail/bycategory/' . $row['category_id']); ?>">
                                                                                        <?= $row['category_name']; ?>
                                                                                    </a>
