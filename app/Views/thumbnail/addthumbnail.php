...
<body>
    <div class="container mt-5">
        <h2 style="text-align: center;">Create Thumbnail 🖼️</h2><br>
        <div class="row">
            <div class="col-md-6" style="margin-left: 290px;">
                <div class="card border ">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('savethumbnail') ?>" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="mb-3 px-1">
                                ...
                                <div class="col-md-6"><br>
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary px-4">Save thumbnail</button>
                                    </div>
                                </div>
                            </div>
                        </form>
