...
<head>
 <title>The Culture Canvas | Dr. Sadhana Paliwal</title>
  <link rel="icon" type="image/x-icon" href="<?= base_url('public/'); ?>assets/fe/images/logo.jpg">
  <meta charset="utf-8">
...
<meta name="csrf-token" content="<?= csrf_hash() ?>">
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url('public/'); ?>assets/fe/css/vendor.css"> 
  <link rel="stylesheet" type="text/css" href="<?= base_url('public/'); ?>assets/fe/css/style.css">
...
<body>
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
    ...
    <div class="offcanvas-header justify-content-between">
      <h4 class="fw-normal text-uppercase fs-6">All Categories</h4>
      <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    ...
    <div class="container-lg">
      <div class="row">
        <div class="col-md-6 copyright text-white">
          <p ><b>© 2025 Culture Canvas. All rights reserved.</b></p>
        </div>
  ...
  <script src="<?= base_url('public/'); ?>assets/fe/js/jquery-1.11.0.min.js"></script>
   <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script> 
  
   <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script> 
  <script src="<?= base_url('public/'); ?>assets/fe/js/plugins.js"></script>
  <script src="<?= base_url('public/'); ?>assets/fe/js/script.js"></script>
  <script>
$(document).on('click', '.download-btn', function() {
    var file = $(this).data('file');

    $.ajax({
        url: "<?= site_url('auth/checkLogin') ?>",
        method: "GET",
        success: function(response) {
            if(response.logged_in){
                window.location.href = "<?= site_url('ppt/download/') ?>" + file;
            } else {
                $('#loginModal').modal('show');
                $('#loginForm').data('file', file); // save file for later
            }
        }
    });
});
  ...
  document.addEventListener("DOMContentLoaded", function () {
    document.querySelectorAll(".read-more-btn").forEach(button => {
      button.addEventListener("click", function () {
        ...
        let fullContent = this.getAttribute("data-full");
        let contentElement = document.getElementById("content-" + id);

        if (this.innerText === "Read More") {
          contentElement.innerHTML = fullContent;
          this.innerText = "Read Less";
        } else {
          contentElement.innerHTML = fullContent.substring(0, 120) + "...";
...
document.getElementById('youtube-link').addEventListener('click', function(e) {
  e.preventDefault();
  openApp(
    "vnd.youtube://channel/UC_x5XG1OV2P6uZZ5FSM9Ttw", // ✅ YouTube App link (channel ID required, not @handle)
    "https://www.youtube.com/@TheCultureCanvas-h1n"       // ✅ Web fallback
  );
});
</script>
<script>
  var swiper = new Swiper(".category-carousel", {
    slidesPerView: 3,   // ek row me kitne card dikhne chahiye
